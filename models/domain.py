...
class Domain(db.Model):
    ...
    register_period =  db.Column(db.Integer, nullable=False)
    ...
    def __init__(self, domain_name, register_period, user_id):
        if not (1 <= register_period <= 9):
        ...
        self.expiry_date = self.registered_date + timedelta(days=register_period * 365)
    ...
    class DomainSchema(ma.Schema):
        ...
        class Meta:
            fields = ("id", "domain_name", "register_period", "registered_date", "expiry_date", "user")
